...
impl MediaHandler {
    ...
    pub async fn list_media(Query(params): Query<SearchParams>) -> ResponseJson<PaginatedResponse<MediaItem>> {
        ...
        let sample_media = vec![
            MediaItem {
                ...
                file_path: "/media/movies/the_matrix.mp4".to_string(),
                file_size: 2_500_000_000, // 2.5 GB
                duration: Some(136),
                metadata: MediaMetadata {
                    ...
                    cast: vec![
                        Person {
                            ...
                            profile_image: Some("https://via.placeholder.com/100x150".to_string()),
                        },
                        Person {
                            id: Uuid::new_v4(),
                            name: "Laurence Fishburne".to_string(),
                            role: "Actor".to_string(),
                            character: Some("Morpheus".to_string()),
                            profile_image: Some("https://via.placeholder.com/100x150".to_string()),
                        },
                    ],
                    crew: vec![],
                    rating: Some(8.7),
                    poster: Some("https://via.placeholder.com/300x450".to_string()),
                    backdrop: Some("https://via.placeholder.com/1920x1080".to_string()),
                    trailer: None,
            ...
            MediaItem {
                ...
                file_path: "/media/tv/breaking_bad".to_string(),
                file_size: 15_000_000_000, // 15 GB
                duration: Some(47),
                metadata: MediaMetadata {
                    title: "Breaking Bad".to_string(),
                    description: Some("A high school chemistry teacher diagnosed with inoperable lung cancer turns to manufacturing and selling methamphetamine.".to_string()),
            ...
            MediaItem {
                ...
                media_type: "movie".to_string(),
                file_path: "/media/movies/inception.mp4".to_string(),
                file_size: 3_200_000_000, // 3.2 GB
                duration: Some(148),
                metadata: MediaMetadata {
                    title: "Inception".to_string(),
                    description: Some("A thief who steals corporate secrets through the use of dream-sharing technology.".to_string()),
                    ...
                    cast: vec![
                        Person {
                            ...
                            role: "Actor".to_string(),
                            character: Some("Dom Cobb".to_string()),
                            profile_image: Some("https://via.placeholder.com/100x150".to_string()),
                        },
                    ],
                    crew: vec![],
    ...
    pub async fn get_media(Path(id): Path<Uuid>) -> impl IntoResponse {
        ...
        let media_item = MediaItem {
            ...
            media_type: "movie".to_string(),
            file_path: "/media/movies/sample.mp4".to_string(),
    ...
    pub async fn search_media(Query(params): Query<SearchParams>) -> ResponseJson<PaginatedResponse<MediaItem>> {
        ...
        let sample_media = vec![
            MediaItem {
                ...
                media_type: "movie".to_string(),
                file_path: "/media/movies/sample1.mp4".to_string(),
            ...
            MediaItem {
                ...
                media_type: "tv_show".to_string(),
                file_path: "/media/tv/sample1".to_string(),
    ...
    pub async fn get_watchlist() -> ResponseJson<PaginatedResponse<MediaItem>> {
        ...
        let watchlist_items = vec![
            MediaItem {
                ...
                media_type: "movie".to_string(),
                file_path: "/media/movies/watchlist1.mp4".to_string(),
